...
<head>
	...
	<title> @yield('seller_page_tittle')</title>
	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Seller Dashboard</span>
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">History</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="star"></i> <span class="align-middle">Manage</span>
            </a>
					</li>
